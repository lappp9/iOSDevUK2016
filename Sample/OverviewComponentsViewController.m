...
#pragma mark ASEditableTextNode
    ...
    editableTextNode.textContainerInset = UIEdgeInsetsMake(16, 16, 16, 16);
    editableTextNode.backgroundColor = [UIColor lightGrayColor];
    editableTextNode.attributedText = [[NSAttributedString alloc] initWithString:@"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum varius nisi quis mattis dignissim."];
...
#pragma mark ASNetworkImageNode
    //If you use alloc-init and allowed PINRemoteImage then caching happens by default
    //I want you to see it download every time though...
    ASNetworkImageNode *networkImageNode = [[ASNetworkImageNode alloc] initWithCache:nil downloader:[ASBasicImageDownloader sharedImageDownloader]];
    ...
    networkImageNode.backgroundColor = ASDisplayNodeDefaultPlaceholderColor();
...
#pragma mark ASMapNode
    ...
    mapNode.backgroundColor = ASDisplayNodeDefaultPlaceholderColor();
...
#pragma mark ASVideoNode
    ...
    videoNode.backgroundColor = ASDisplayNodeDefaultPlaceholderColor();
...
#pragma mark ASScrollNode
    UIImage *scrollNodeImage = [UIImage imageNamed:@"image.jpg"];
